...
const MAVisualizations = {
    ...
    drawPositionTradingExample(canvasId, progress = 1) {
        ...
        Canvas.drawText(ctx, '● 200 SMA', pad + 55, legendY, CONFIG.colors.purple, 9, 'left');
        Canvas.drawText(ctx, '● Cross/Entry', pad + 125, legendY, CONFIG.colors.gold, 9, 'left');
        Canvas.drawText(ctx, '● Stop', pad + 200, legendY, CONFIG.colors.red, 9, 'left');
    }
};
