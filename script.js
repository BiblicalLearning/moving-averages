...
const MAVisualizations = {
    ...
    drawDayTradingExample(canvasId, progress = 1) {
        ...
        // Simplified legend - centered for mobile
        const legendY = h - 18;
        const legendStart = (w - 200) / 2; // Center the legend block
        Canvas.drawText(ctx, '● 9 EMA', legendStart, legendY, CONFIG.colors.red, 9, 'left');
        Canvas.drawText(ctx, '● 20 EMA', legendStart + 50, legendY, CONFIG.colors.gold, 9, 'left');
        Canvas.drawText(ctx, '● Entry', legendStart + 110, legendY, CONFIG.colors.green, 9, 'left');
        Canvas.drawText(ctx, '● Exit', legendStart + 155, legendY, CONFIG.colors.gold, 9, 'left');
    },
    ...
    drawSwingTradingExample(canvasId, progress = 1) {
        ...
        // Simplified legend - centered for both desktop and mobile
        const legendY = h - 18;
        const legendStart = (w - 180) / 2; // Center the legend block
        Canvas.drawText(ctx, '● 20 SMA', legendStart, legendY, CONFIG.colors.green, 9, 'left');
        Canvas.drawText(ctx, '● 50 SMA', legendStart + 55, legendY, CONFIG.colors.blue, 9, 'left');
        Canvas.drawText(ctx, '● Entry', legendStart + 110, legendY, CONFIG.colors.green, 9, 'left');
        Canvas.drawText(ctx, '● Stop', legendStart + 155, legendY, CONFIG.colors.red, 9, 'left');
    },
    ...
    drawPositionTradingExample(canvasId, progress = 1) {
        ...
        const legendY = h - 18;
        const legendStart = (w - 180) / 2; // Center the legend block
        Canvas.drawText(ctx, '● 50 SMA', legendStart, legendY, CONFIG.colors.green, 9, 'left');
        Canvas.drawText(ctx, '● 200 SMA', legendStart + 55, legendY, CONFIG.colors.purple, 9, 'left');
        Canvas.drawText(ctx, '● Entry', legendStart + 120, legendY, CONFIG.colors.gold, 9, 'left');
        Canvas.drawText(ctx, '● Stop', legendStart + 165, legendY, CONFIG.colors.red, 9, 'left');
    }
};
